...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT_60_iso_split_rshift(
        ...
        KC_LCTL, MO(2),   KC_LALT,                C(KC_BSPC), KC_LGUI, KC_SPC,           KC_RALT, XXXXXXX,  MO(2),  KC_RCTL
    ),
    ...
    LAYOUT_60_iso_split_rshift(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_BRIU, _______, _______, _______, RESET,
